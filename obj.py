...
class PessoaFisica(Cliente):
    def __init__(self, nome, data_nascimento, cpf, endereco):
        if not PessoaFisica.validacao_cpf(cpf):
            raise ValueError("CPF inválido, por favor informe um CPF válido.")
...
def criar_conta(clientes, contas):
    ...
    conta = ContaCorrente.nova_conta(cliente=cliente, numero=uuid_9digit)
    contas.append(conta)
